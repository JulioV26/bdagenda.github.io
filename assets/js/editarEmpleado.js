...
async function cargarDatosEmpleadoEditar(idEmpleado) {
  try {
    ...
    if (response.status === 200) {
      const { id, nombre, apaterno, amaterno, genero, fecha_nacimiento, telefono, email, linkedin, avatar } =
        response.data;

      console.log(id, nombre, apaterno, amaterno, genero, fecha_nacimiento, telefono, email, linkedin, avatar);
      document.querySelector("#idempleado").value = id;
      document.querySelector("#nombre").value = nombre;
      document.querySelector("#apaterno").value = apaterno;
      document.querySelector("#amaterno").value = amaterno;
